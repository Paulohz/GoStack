...
describe('CreateAppointment', function () {
    it('should be able to create a new appointment', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, createAppoinmentService, appointment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeAppointmentsRepository_1.default();
                    createAppoinmentService = new CreateAppointmentService_1.default(fakeAppointmentsRepository);
                    return [4 /*yield*/, createAppoinmentService.execute({
                            date: new Date(),
                            provider_id: '1213151',
                        })];
                case 1:
    ...
    it('should not be able to create two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, createAppoinmentService, appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeAppointmentsRepository_1.default();
                ...
                case 1:
                    _a.sent();
                    expect(createAppoinmentService.execute({
                        date: appointmentDate,
                        provider_id: '1213151',
